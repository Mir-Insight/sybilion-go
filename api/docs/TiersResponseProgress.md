...
**MaxSinglePaymentCents** | **int64** | Largest single payment amount (in EUR cents) on the caller&#39;s account; 0 if none. | 
**PaymentCount** | **int32** |  | 
...
`func NewTiersResponseProgress(lifetimePaidCents int64, maxSinglePaymentCents int64, paymentCount int32, ) *TiersResponseProgress`
