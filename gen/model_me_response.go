...
// MeResponse Authenticated user snapshot. Monetary fields are exposed as integer EUR cents (1 EUR = 100 cents). Internally the billing system uses credits; the API converts at this boundary using BILLING_CREDITS_PER_EURO. 
