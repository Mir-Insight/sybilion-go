...
**MinLifetimePaidCents** | **int64** | Minimum cumulative Stripe payment (in cents) required for this tier. | 
**MinPaymentCount** | **int32** | Minimum number of completed Stripe payments required for this tier. | 
**MinSinglePaymentCents** | **int64** | Minimum single Stripe payment amount (in cents) required for this tier; 0 means no constraint. | 
...
**MaxConcurrentJobs** | **int32** | Cap on the user&#39;s in-flight async_jobs (pending/queued/running) at this tier. | 
